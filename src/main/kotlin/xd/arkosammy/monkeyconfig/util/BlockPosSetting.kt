...
open class BlockPosSetting @JvmOverloads constructor(
    ...
    override var value: BlockPos = defaultValue
) : AbstractCommandControllableSetting<BlockPos, ListType<NumberType<Int>>, BlockPosArgumentType>(settingLocation, comment, defaultValue, value) {
    ...
    ) : ConfigSetting.Builder<BlockPosSetting, BlockPos, ListType<NumberType<Int>>>(settingLocation, comment, defaultValue) {

        override fun build(): BlockPosSetting =
            BlockPosSetting(settingLocation, comment, defaultValue)
