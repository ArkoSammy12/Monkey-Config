...
open class BooleanListSetting @JvmOverloads constructor(
    ...
    value: List<Boolean> = defaultValue
) : ListSetting<Boolean, BooleanType>(settingLocation, comment, defaultValue, value) {
    ...
    open class Builder @JvmOverloads constructor(
        ...
        comment: String? = null,
        defaultValue: List<Boolean>
    ) : ListSetting.Builder<Boolean, BooleanType>(settingLocation, comment, defaultValue) {

        override fun build(): BooleanListSetting =
            BooleanListSetting(this.settingLocation, this.comment, this.defaultValue)
