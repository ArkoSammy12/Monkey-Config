...
open class StringListSetting @JvmOverloads constructor(
    ...
    value: List<String> = defaultValue
) : ListSetting<String, StringType>(settingLocation, comment, defaultValue, value) {
    ...
    open class Builder @JvmOverloads constructor(
        ...
        comment: String? = null,
        defaultValue: List<String>
    ) : ListSetting.Builder<String, StringType>(settingLocation, comment, defaultValue) {

        override fun build(): StringListSetting =
            StringListSetting(this.settingLocation, this.comment, this.defaultValue)
